...
docker create \
  ...
  -e 'NEXTAUTH_SECRET'='YjE4P7yPkvN9wX2vJ6sZqFp8nQ5rT2uXyA7bC9dE1g=' \
  -e 'NEXTAUTH_URL'='https://medlog.dalc.in' \
  -e 'FILES_PATH'='/app/data/uploads' \
  -e 'SKIP_MIGRATIONS'='true' \
  -l net.unraid.docker.managed=dockerman \
  -l net.unraid.docker.webui='https://medlog.dalc.in' \
...
echo "======================================"
echo ""
echo "Acesse: https://medlog.dalc.in"
echo ""
