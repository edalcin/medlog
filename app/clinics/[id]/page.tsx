...
export default function ClinicDetailsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!clinic?.canEdit) {
      setError('Você não tem permissão para editar esta clínica. Apenas administradores e o criador do registro podem editar.')
      return
    }
      ...
      {!clinic?.canEdit && (
        <div className="mb-4 bg-blue-50 border border-blue-200 rounded-md p-4">
          <p className="text-blue-800 text-sm">
            ℹ️ Esta clínica foi compartilhada com você. Apenas administradores e o criador do registro podem editar.
          </p>
        </div>
      )}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="flex justify-between items-center pt-4">
            <button
              ...
              disabled={submitting || !clinic?.canEdit}
